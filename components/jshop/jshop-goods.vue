<template>
	<view class="index-goods">
		<!-- 列表平铺两列三列 -->
		<view class='img-grids bottom-cell-group' v-if="jdata.params.column == '2' && jdata.params.display == 'list' || jdata.params.column == '3' && jdata.params.display == 'list'"
		 v-bind:class="'column'+jdata.params.column">
			<view class='cell-item right-img' v-if="jdata.params.title != ''">
				...
				<view class='cell-item-ft' v-if="jdata.params.lookMore == 'true'">
					...
					<text class='cell-ft-text' @click="goodsList({sortBy: jdata.sortBy})">查看更多</text>
				</view>
			</view>
			...
			<view class="" v-if="count">
				<view class="img-grids-item" v-for="item in jdata.params.list" :key="item.id" @click="goodsDetail(item.id)">
					<image class="img-grids-item-t have-none" :src="item.images" mode='aspectFill'></image>
		...
		<view class="img-list bottom-cell-group" v-if="jdata.params.column == '1' && jdata.params.display == 'list'">
			...
			<view v-if="count">
				<view class="img-list-item" v-for="(item, index) in jdata.params.list" :key="index" @click="goodsDetail(item.id)">
					<image class="img-list-item-l have-none" :src="item.images" mode='aspectFill'></image>
		...
		<!-- 横向滚动 -->
		<view class='img-grids bottom-cell-group' v-if="jdata.params.column == '2' && jdata.params.display == 'slide' || jdata.params.column == '3' && jdata.params.display == 'slide'"
