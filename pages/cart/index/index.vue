			...
			<view class="cell-group margin-cell-group">
				<view class="cell-item">
					...
					<view class="cell-item-bd">
						<text class="cell-bd-text">宝励商城</text>
					</view>
					...
					<view class="">
						<label class="uni-list-cell uni-list-cell-pd">
							<view class="cart-checkbox-c">
								<checkbox color="#FF7159" :checked="item.selected" :value="item.id" :disabled="item.stockNo" v-if="item.stockNo" class="checkboxNo" />
								<checkbox color="#FF7159" :checked="item.selected" :value="item.id" v-else/>
							</view>
						</label>
						<view class="img-list-item">
							...
							<view class="img-list-item-r little-right">
								<view class="little-right-t">
									<view class="goods-name list-goods-name" @click="goodsDetail(item.spuId)">
										{{ item.skuName }}
									</view>
								...
								<view class="goods-item-c">
									<view class="goods-buy">
										<!-- 商品规格 -->
										<view class="goods-salesvolume" v-if="item.skuParam">
											{{ item.skuParam }}
										</view>
										...
										<view class="goods-numbox">
											...
											<uni-number-box v-on:change="bindChange($event, item)" :min="1" :max="item.maxStock" :value="item.quantity" v-if="!editStatus"></uni-number-box>
